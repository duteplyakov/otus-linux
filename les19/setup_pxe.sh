...
LABEL linux
  ...
  append initrd=images/CentOS-8.2/initrd.img ip=enp0s3:dhcp inst.repo=http://10.0.0.20:8081
LABEL linux-auto
  menu label ^Auto install system
  kernel images/CentOS-8.2/vmlinuz
  append initrd=images/CentOS-8.2/initrd.img ip=enp0s3:dhcp inst.ks=http://10.0.0.20:8081/ks.cfg inst.repo=http://10.0.0.20:8081
LABEL vesa
...
cp /home/vagrant/cfg/ks.cfg /usr/share/nginx/
cp -r /mnt/centos8-autoinstall/. /usr/share/nginx
