...
[root@les15 ~]# awk -F':' '{print $1":"$4}' /etc/passwd | grep `awk -F':' '/^admin:/{print $3}' /etc/group` | awk -F':' '{print $1}' | sed ':b;$!{N;bb};s/\n/|/g' | awk '{print "*;*;!|"$0";AlStSn"
}' >> /etc/security/time.conf
[root@les15 ~]#

[root@les15 ~]# cat^C
[root@les15 ~]#
[root@les15 ~]# echo '*;*;admin;Al'  >> /etc/security/time.conf
[root@les15 ~]# cat /etc/security/time.conf | grep admin
#*;*;admin;Al
admin:1001
*;*;!|porter|moderator|admin;AlStSn
(reverse-i-search)`ssh': cat /etc/pam.d/^Chd | grep pam_time
[root@les15 ~]# ssh ^C
[root@les15 ~]# ssh admin@127.0.0.1time.conf
admin@127.0.0.1's password:
Last failed login: Tue Apr 19 07:33:40 UTC 2022 from 127.0.0.1 on ssh:notty
...
Last failed login: Tue Apr 19 08:44:11 UTC 2022 on pts/0
...
Last failed login: Tue Apr 19 09:21:57 UTC 2022 from 127.0.0.1 on ssh:notty
There were 4 failed login attempts since the last successful login.
[user001@hw015 ~]$ exit
logout
Connection to 127.0.0.1 closed.
[root@hw015 ~]# date
Tue Apr 19 09:55:41 UTC 2022
[root@les15 ~]# datedate -s "2 OCT 2006 18:00:00"^C
[root@les15 ~]# date -s "2 OCT 2006 18:00:00"
Mon Oct  2 18:00:00 UTC 2006
[root@les15 ~]# date
Mon Oct  2 18:00:03 UTC 2006
[root@les15 ~]# ssh user001@127.0.0.1
user001@127.0.0.1's password:
Last login: Tue Apr 19 09:55:35 2022 from 127.0.0.1
[user001@les15 ~]$ exit
logout
Connection to 127.0.0.1 closed.
[root@les15 ~]# ssh user002@127.0.0.1
user002@127.0.0.1's password:
Last failed login: Tue Apr 19 09:21:46 UTC 2022 from 127.0.0.1 on ssh:notty
There were 3 failed login attempts since the last successful login.
[user002@les15 ~]$ exit
logout
Connection to 127.0.0.1 closed.
[root@les15 ~]# date -s "8 OCT 2006 18:00:00"
